...
function modalMan() {
    ...
    getDOM('doacao25', '#doacao25').addEventListener('click', function () {
        ...
        getDOM('img-pix', '.img-pix_qr').setAttribute('src', "./../images/img/DOACAO25.png")
    ...
    getDOM('doacao50', '#doacao50').addEventListener('click', function () {
        /*    Pix Copia e Cola IMG-QR */
        getDOM('img-pix', '.img-pix_qr').setAttribute('src', "./../images/img/DOACAO50.png")
        /* Pix Copia e Cola num */
    ...
    getDOM('doacao100', '#doacao100').addEventListener('click', function () {
        /*    Pix Copia e Cola IMG-QR */
        getDOM('img-pix', '.img-pix_qr').setAttribute('src', "./../images/img/DOACAO100.png")
        /* Pix Copia e Cola num */
    ...
    getDOM('btnDoacao', '.btnDoacao_outrosValores').addEventListener('click', function () {
        /*    Pix Copia e Cola IMG-QR */
        getDOM('img-pix', '.img-pix_qr').setAttribute('src', "./../images/img/DOACAOoutrosValores.png")
        /* Pix Copia e Cola num */
